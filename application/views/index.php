...
.overlay{
        ...
        left: 0;
        z-index: 999;
        background: rgba(255,255,255,0.8) url("<?php echo base_url()?>assets/images/1494.gif") center no-repeat;
    }
...
<div class="overlay"></div>
    ...
    <div class="header_section">
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="logo"><a href="index.html"><img height="60px" width="120px" src="<?php echo base_url()?>assets/images/logo.png"></a></div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-lg-4">
            ...
            <div class="map_icon"><img src="<?php echo base_url()?>/assets/images/map-icon.png"><span class="paddlin_left_0">India</span></div>
            <div class="map_icon_1"><img src="<?php echo base_url()?>/assets/images/call-icon.png"><span class="paddlin_left_0">+919999999999</span></div>
            <div class="map_icon"><img src="<?php echo base_url()?>/assets/images/mail-icon.png"><span class="paddlin_left_0">prince@gmail.com</span></div>
          </div>
        </div>
      </div>
    </div>
...
function get_asteroid_data(){
    ...
    $("body").addClass("loading"); 
                    $.ajax({
                        url :"<?php echo base_url()?>"+"index.php/dashboard/get_asteroid_data",
                        type: 'POST',
                        dataType :'JSON',
